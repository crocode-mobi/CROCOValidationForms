...
#define COCOAPODS_POD_AVAILABLE_CROCOValidationForms
#define COCOAPODS_VERSION_MAJOR_CROCOValidationForms 0
#define COCOAPODS_VERSION_MINOR_CROCOValidationForms 1
#define COCOAPODS_VERSION_PATCH_CROCOValidationForms 0
